 ...
 */
public class BookDiscountAdapter extends ArrayAdapter<String> {
    ...
    public BookDiscountAdapter(final Context context, final int textViewResourceId) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        ViewHolder vh;
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.market_activity_book_discount_item, parent, false);
            vh = new ViewHolder();
