 ...
 */
public class HeaderAndFooterFileRoomAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HeaderAndFooterFileRoomAdapter() {
    }

    public HeaderAndFooterFileRoomAdapter(RecyclerView.Adapter innerAdapter) {
