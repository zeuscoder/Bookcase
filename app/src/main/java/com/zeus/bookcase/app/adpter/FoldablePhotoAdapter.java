...
public class FoldablePhotoAdapter extends RecyclerView.Adapter<FoldablePhotoAdapter.PhotoViewHolder> {
    ...
    public FoldablePhotoAdapter(String[] dataSet, Context context) {
        mDataSet = dataSet;
        mContext = context;
    }
...
/*                Intent shareIntent = new Intent(Intent.ACTION_SEND);
    ...
    protected static class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        public PhotoViewHolder(FoldableLayout foldableLayout) {
            ...
            foldableLayout.setupViews(R.layout.app__book_list_item_cover, R.layout.app__book_list_item_detail, R.dimen.card_cover_height, itemView.getContext());
