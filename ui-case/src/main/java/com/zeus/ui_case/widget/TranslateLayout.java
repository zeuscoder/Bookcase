package com.zeus.ui_case.widget;
...
import com.zeus.ui_case.utils.MenuUtils;
...
public class TranslateLayout extends FrameLayout implements View.OnClickListener {
    ...
    private void init() {
        if (!isInEditMode()) {
            setWillNotDraw(true);
            inflate(getContext(), R.layout.case_menu_topbar, this);
            view = getChildAt(0);
            ...
            mMenu = (ImageView) view.findViewById(R.id.case_book_menu_icon);
            mTitle = (TextView) view.findViewById(R.id.case_book_menu_title);
    ...
    public float getXFraction() {
        int width = MenuUtils.getScreenWidth(getContext());
    ...
    public float getYFraction() {
        int height = MenuUtils.getScreenHeight(getContext());
...
//        mMenu.setAlpha(fraction);
    ...
    public void onClick(View v) {
        if (R.id.case_book_menu_icon == v.getId()) {
