...
import com.zeus.ui_case.adapter.FilmRoomAdapter;
import com.zeus.ui_case.adapter.HeaderAndFooterFileRoomAdapter;
import com.zeus.ui_case.utils.DeviceUtils;
import com.zeus.ui_case.utils.FilmLinearLayoutManager;
import com.zeus.ui_case.utils.FilmViewUtils;
...
public class FilmRoomActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.case_activity_film);
        initTopButton(R.string.activity_film, R.mipmap.case_arrow_back, 0);
        ...
        View moreView = getLayoutInflater().inflate(R.layout.case_film_footer_more, null);
